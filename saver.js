...
[{
  "imya": "Имя кто поднял tension (или пустая строка если не указано)",
  "vopros": "Краткое описание tension — что за вопрос/проблема",
  "pochemu": "Почему это важно — причина, контекст, влияние на команду",
  "shagi": "Предложенные шаги или кто должен помочь (или пустая строка если не было)",
  "reshili": "нет",
  "data": "Дата или дедлайн если упомянут (или пустая строка)",
  "status": "🔴 или 🟡"
}]
