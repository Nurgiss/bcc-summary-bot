...
Новые:
🔴 Нариман — В Jira фиксируется меньше задач чем реально обсуждается на стендапах
Почему важно: Создаёт ощущение что работы нет, блокеры не видны вовремя
Возможные шаги: Любая устная договорённость фиксируется в Jira с ответственным и результатом

🟡 Дида — Figma-файл проекта X не структурирован — сложно передавать разработке
Почему важно: Тормозит хэндовер, разработчики задают одни и те же вопросы
Возможные шаги: Ввести обязательный чеклист перед передачей макетов

Прошлые:
✅ Марат — Нет единого шаблона именования слоёв
Почему важно: Разные конвенции у дизайнеров замедляют ревью
Возможные шаги: Договорились и внедрили общий шаблон

🟡 Алина — Ревью макетов до передачи в разработку не проводится системно
Почему важно: Баги попадают в разработку и возвращаются обратно
Возможные шаги: Каждый макет проходит ревью у второго дизайнера перед хэндовером
